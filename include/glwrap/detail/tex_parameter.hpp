...
{
	GLWRAP_GL_CALL(glGetTexParameterfv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glGetTexParameteriv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glGetTexParameterIiv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glGetTexParameterIuiv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glTexParameterf)(_target, _pname, _param);
}
...
{
	GLWRAP_GL_CALL(glTexParameterfv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glTexParameteri)(_target, _pname, _param);
}
...
{
	GLWRAP_GL_CALL(glTexParameteriv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glTexParameterIiv)(_target, _pname, _params);
}
...
{
	GLWRAP_GL_CALL(glTexParameterIuiv)(_target, _pname, _params);
}
