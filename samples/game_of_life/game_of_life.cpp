...
int main()
{
	...
	auto const tex_format = gl::normalized_image_format::r8u;

	gl::texture_2d tex_data_front(glc), tex_data_back(glc);
	tex_data_front.define_storage(1, tex_format, grid_size);
	tex_data_back.define_storage(1, tex_format, grid_size);
...
void main(void)
{
	...
	dsp.set_display_func([&]
	{
		...
		glc.bind_image_texture(cell_image_unit, tex_data_back, 0, gl::image_access::read_only, tex_format);
